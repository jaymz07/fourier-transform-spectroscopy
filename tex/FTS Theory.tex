...
\begin{document}
	...
	\begin{itemize}
		...
		\item
		\textbf{Channel 2 (High-Gain):} This channel will likely experience clipping during the peak of the interferogram but provides high-precision data for the detailed low-amplitude fringes.
	\end{itemize}
